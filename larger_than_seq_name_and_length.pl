#!/usr/bin/perl -w
# This script will read one fasta file and write to a new fasta file just the identifer and length of those sequences bigger than a specified length. 
# Megan Bowman
# 15 November 2013
...
my ($id, $desc, $seq, $length, $seqobj, $check, $key);
